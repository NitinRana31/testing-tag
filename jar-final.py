...
def replace_jar_placeholder_in_dockerfile(dockerfile_path, jar_file):
   """
   Replaces all occurrences of the placeholder '${project.artifactId}-${project.version}.jar'
   in the Dockerfile with the actual jar file found in the 'target' directory.
   """
   ...
   with open(dockerfile_path, "w") as file:
       for line in lines:
           ...
           if "${project.artifactId}-${project.version}.jar" in line:
