...
# def remove_microdnf_install(dockerfile_path):
#     with open(dockerfile_path, "r") as file:
#         lines = file.readlines()
#     with open(dockerfile_path, "w") as file:
#         for line in lines:
#             if "RUN microdnf update && microdnf install -y java-1.8.0-openjdk-devel wget tar gzip shadow-utils && microdnf clean all" in line:
